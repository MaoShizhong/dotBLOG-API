...
exports.removeDangerousScriptTags = exports.deletePost = exports.toggleFeaturedPublished = exports.editPost = exports.postNewPost = exports.getBookmarkedPosts = exports.getSpecificPost = exports.getAllPosts = exports.DOES_NOT_EXIST = exports.INVALID_QUERY = exports.INVALID_ID = void 0;
...
const INVALID_ID = { message: 'Failed to fetch - invalid ID format' };
exports.INVALID_ID = INVALID_ID;
const INVALID_QUERY = { message: 'Failed to fetch - invalid query' };
exports.INVALID_QUERY = INVALID_QUERY;
const DOES_NOT_EXIST = { message: 'Failed to fetch - no resource with that ID' };
...
// GET INDIVIDUAL POST
const getSpecificPost = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
// GET BOOKMARKS
const getBookmarkedPosts = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
/*
    - PATCH
*/
const toggleFeaturedPublished = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.Types.ObjectId.isValid(req.params.postID)) {
        res.status(400).json(INVALID_ID);
        return;
    }
